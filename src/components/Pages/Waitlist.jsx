...
export default function WaitList() {
    return (
        <div className="div text-white flex px-40 py-30 flex-col place-items-center gap-30">
            <div className="flex flex-col gap-20">
                <div className="flex flex-col gap-20">
                    ...
                    <div className="flex flex-col gap-10 place-items-center">
                        <div className="flex w-full px-20 gap-5 place-items-center">
                            ...
                            <Link
                                to="/Waitlist"
                                className="bg-white text-black text-center py-4 px-5 rounded-xl font-semibold hover:opacity-90 transition">
                                Join Waitlist
                            </Link>
                        </div>
                        <div className="flex flex-row items-center px-20 gap-1">
                            <img
                                className="h-5 w-5"
                                src="https://framerusercontent.com/images/lvuKg4x2aNtdE9KCJ5H0BUAeEo.svg"></img>
                            <h2 className="text-white/60 font-light text-xl">No Spam, Only Genuine Updates</h2>
                        </div>
                        <div className="div">
